    ...
    user.save((err, user) => {
        ...
        if(req.body.roles){
            ...
            (err, roles) => {
                ...
                // save the role and map it to the respective role id
            ...
            // else assign the 'user' role, if role is not specified..while registering 
...
exports.signin = (req, res) => {
    ...
    .exec((err, user) =>{
        ...
        // check if pwd corresponds to the pwd in the server
